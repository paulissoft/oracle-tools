...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(1866639046875135)
,p_name=>'AAA'
,p_message_text=>'gfggf'
);
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(1866796053877893)
,p_name=>'AAA'
...
begin
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(5572219011136585)
...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(5980362279007639)
,p_name=>'ORACLE_TOOLS.FINISH_LOAD_FILE'
,p_message_language=>'fr'
...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(5570694141077211)
...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(5980271090007639)
,p_name=>'ORACLE_TOOLS.LOAD_FILE_WITHOUT_HISTORY'
,p_message_language=>'fr'
