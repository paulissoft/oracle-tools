...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(9400941074979582)
,p_lov_name=>'LOV_DETERMINE_DATATYPE'
,p_lov_query=>'.'||wwv_flow_api.id(9400941074979582)||'.'
,p_location=>'STATIC'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9401217415979606)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Datatype string, length max'
,p_lov_return_value=>'0'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9401634159979607)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Datatype exact, length min'
,p_lov_return_value=>'1'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(9402040814979608)
