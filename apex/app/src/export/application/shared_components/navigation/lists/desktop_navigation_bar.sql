...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(44969786949156234)
,p_name=>'Desktop Navigation Bar'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(44990930002156343)
...
,p_required_patch=>wwv_flow_api.id(44972422349156272)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(47078080825281181)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(44991685009156343)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(44992039381156343)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(44992486185156343)
,p_list_item_display_sequence=>60
,p_list_item_link_text=>'---'
,p_list_item_link_target=>'separator'
,p_parent_list_item_id=>wwv_flow_api.id(44992039381156343)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(44992879082156343)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(56923596499207156)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(56922500460197407)
,p_list_item_display_sequence=>90
,p_list_item_link_text=>'English'
,p_list_item_link_target=>'javascript:apex.submit(''en'')'
,p_parent_list_item_id=>wwv_flow_api.id(56923596499207156)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(56922149114195337)
