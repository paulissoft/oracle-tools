...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(62958975534067070)
,p_name=>'Desktop Navigation Bar'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(62937832481066961)
...
,p_required_patch=>wwv_flow_api.id(62956340134067032)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(60850681657942123)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(62937077474066961)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(62936723102066961)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(62936276298066961)
,p_list_item_display_sequence=>60
,p_list_item_link_text=>'---'
,p_list_item_link_target=>'separator'
,p_parent_list_item_id=>wwv_flow_api.id(62936723102066961)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(62935883401066961)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(51005165984016148)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(51006262023025897)
,p_list_item_display_sequence=>90
,p_list_item_link_text=>'English'
,p_list_item_link_target=>'javascript:apex.submit(''en'')'
,p_parent_list_item_id=>wwv_flow_api.id(51005165984016148)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(51006613369027967)
