...
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(62956340134067032)
...
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(62956285698067032)
...
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(61013755196121719)
,p_build_option_name=>'Not used'
,p_build_option_status=>'EXCLUDE'
,p_build_option_comment=>'An unused item'
);
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(45552537724023225)
...
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(45552001293992749)
