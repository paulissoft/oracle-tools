...
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(49555638194366314)
...
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(49555583758366314)
...
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(47613053256421001)
,p_build_option_name=>'Not used'
,p_build_option_status=>'EXCLUDE'
,p_build_option_comment=>'An unused item'
);
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(32151835784322507)
...
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(32151299354292031)
