...
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(56155949795480907)
...
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(56155895359480907)
...
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(54213364857535594)
,p_build_option_name=>'Not used'
,p_build_option_status=>'EXCLUDE'
,p_build_option_comment=>'An unused item'
);
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(38752147385437100)
...
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(38751610955406624)
