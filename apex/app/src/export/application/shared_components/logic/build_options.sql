...
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(69956670266748003)
...
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(69956615830748003)
...
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(68014085328802690)
,p_build_option_name=>'Not used'
,p_build_option_status=>'EXCLUDE'
,p_build_option_comment=>'An unused item'
);
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(52552867856704196)
...
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(52552331426673720)
