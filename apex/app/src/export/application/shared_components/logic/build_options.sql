...
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(82057055297338040)
...
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(82057000861338040)
...
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(80114470359392727)
,p_build_option_name=>'Not used'
,p_build_option_status=>'EXCLUDE'
,p_build_option_comment=>'An unused item'
);
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(64653252887294233)
...
wwv_flow_api.create_build_option(
 p_id=>wwv_flow_api.id(64652716457263757)
