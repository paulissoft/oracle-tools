...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(60799519905109384)
,p_name=>'AAA'
,p_message_text=>'gfggf'
);
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(60799362898106626)
,p_name=>'AAA'
...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(57093939940847934)
...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(56685796672976880)
,p_name=>'ORACLE_TOOLS.FINISH_LOAD_FILE'
,p_message_language=>'fr'
...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(57095464810907308)
...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(56685887861976880)
,p_name=>'ORACLE_TOOLS.LOAD_FILE_WITHOUT_HISTORY'
,p_message_language=>'fr'
