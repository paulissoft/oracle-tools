...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(66229957741384928)
,p_name=>'AAA'
,p_message_text=>'gfggf'
);
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(66230114748387686)
,p_name=>'AAA'
...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(69935537705646378)
...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(70343680973517432)
,p_name=>'ORACLE_TOOLS.FINISH_LOAD_FILE'
,p_message_language=>'fr'
...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(69934012835587004)
...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(70343589784517432)
,p_name=>'ORACLE_TOOLS.LOAD_FILE_WITHOUT_HISTORY'
,p_message_language=>'fr'
