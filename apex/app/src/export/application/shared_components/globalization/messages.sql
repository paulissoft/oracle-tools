...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(53699137198242605)
,p_name=>'AAA'
,p_message_text=>'gfggf'
);
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(53698980191239847)
,p_name=>'AAA'
...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(49993557233981155)
...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(49585413966110101)
,p_name=>'ORACLE_TOOLS.FINISH_LOAD_FILE'
,p_message_language=>'fr'
...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(49995082104040529)
...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(49585505155110101)
,p_name=>'ORACLE_TOOLS.LOAD_FILE_WITHOUT_HISTORY'
,p_message_language=>'fr'
