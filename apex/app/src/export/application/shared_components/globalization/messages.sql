...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(46892817429608105)
,p_name=>'AAA'
,p_message_text=>'gfggf'
);
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(46892660422605347)
,p_name=>'AAA'
...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(43187237465346655)
...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(42779094197475601)
,p_name=>'ORACLE_TOOLS.FINISH_LOAD_FILE'
,p_message_language=>'fr'
...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(43188762335406029)
...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(42779185386475601)
,p_name=>'ORACLE_TOOLS.LOAD_FILE_WITHOUT_HISTORY'
,p_message_language=>'fr'
