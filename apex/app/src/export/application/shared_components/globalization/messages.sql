...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(47129242578113920)
,p_name=>'AAA'
,p_message_text=>'gfggf'
);
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(47129399585116678)
,p_name=>'AAA'
...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(50834822542375370)
...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(51242965810246424)
,p_name=>'ORACLE_TOOLS.FINISH_LOAD_FILE'
,p_message_language=>'fr'
...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(50833297672315996)
...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(51242874621246424)
,p_name=>'ORACLE_TOOLS.LOAD_FILE_WITHOUT_HISTORY'
,p_message_language=>'fr'
