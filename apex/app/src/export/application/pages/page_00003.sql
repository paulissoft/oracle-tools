...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(56482505258961575)
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(56480212700961553)
,p_name=>'VIEW_NAME'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(56479636039961551)
,p_name=>'FILE_NAME'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(56478959001961550)
,p_name=>'MIME_TYPE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(56478418224961550)
,p_name=>'OBJECT_NAME'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(56477796689961550)
,p_name=>'SHEET_NAMES'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(56477209823961549)
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(56474215137961548)
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(56473664060961548)
...
,p_is_required=>true
,p_lov_type=>'SHARED'
,p_lov_id=>wwv_flow_api.id(71120390037755252)
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(31064153468372635)
,p_name=>'DATA_ROWS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(31064057474372634)
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(30392523826236854)
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(30392464179236853)
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(30390353114236832)
,p_name=>'HEADER_ROWS'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(30175986567830561)
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(30175597196830557)
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(30175303607830554)
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(30175183789830553)
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(30173162546830533)
,p_name=>'CREATED'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_interactive_grid(
 p_id=>wwv_flow_api.id(56481991296961567)
...
wwv_flow_api.create_ig_report(
 p_id=>wwv_flow_api.id(56481559391961564)
,p_interactive_grid_id=>wwv_flow_api.id(56481991296961567)
,p_static_id=>'297035'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_rows_per_page=>5
...
wwv_flow_api.create_ig_report_view(
 p_id=>wwv_flow_api.id(56481460615961563)
,p_report_id=>wwv_flow_api.id(56481559391961564)
,p_view_type=>'GRID'
...
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(56479756356961552)
,p_view_id=>wwv_flow_api.id(56481460615961563)
,p_display_seq=>1
,p_column_id=>wwv_flow_api.id(56480212700961553)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(56479218105961550)
,p_view_id=>wwv_flow_api.id(56481460615961563)
,p_display_seq=>2
,p_column_id=>wwv_flow_api.id(56479636039961551)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>200
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(56478560466961550)
,p_view_id=>wwv_flow_api.id(56481460615961563)
,p_display_seq=>4
,p_column_id=>wwv_flow_api.id(56478959001961550)
,p_is_visible=>false
,p_is_frozen=>false
,p_width=>100
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(56478042102961550)
,p_view_id=>wwv_flow_api.id(56481460615961563)
,p_display_seq=>8
,p_column_id=>wwv_flow_api.id(56478418224961550)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>170
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(56477447997961549)
,p_view_id=>wwv_flow_api.id(56481460615961563)
,p_display_seq=>7
,p_column_id=>wwv_flow_api.id(56477796689961550)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>100
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(56476826636961549)
,p_view_id=>wwv_flow_api.id(56481460615961563)
,p_display_seq=>6
,p_column_id=>wwv_flow_api.id(56477209823961549)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>90
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(56473883644961548)
,p_view_id=>wwv_flow_api.id(56481460615961563)
,p_display_seq=>10
,p_column_id=>wwv_flow_api.id(56474215137961548)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>110
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(56473308552961548)
,p_view_id=>wwv_flow_api.id(56481460615961563)
,p_display_seq=>16
,p_column_id=>wwv_flow_api.id(56473664060961548)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>180
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(31570953238710689)
,p_view_id=>wwv_flow_api.id(56481460615961563)
,p_display_seq=>11
,p_column_id=>wwv_flow_api.id(31064153468372635)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>50
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(31570480685710685)
,p_view_id=>wwv_flow_api.id(56481460615961563)
,p_display_seq=>15
,p_column_id=>wwv_flow_api.id(31064057474372634)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(30503486137405143)
,p_view_id=>wwv_flow_api.id(56481460615961563)
,p_display_seq=>14
,p_column_id=>wwv_flow_api.id(30392523826236854)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(30502841001405137)
,p_view_id=>wwv_flow_api.id(56481460615961563)
,p_display_seq=>13
,p_column_id=>wwv_flow_api.id(30392464179236853)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(30467329978283759)
,p_view_id=>wwv_flow_api.id(56481460615961563)
,p_display_seq=>9
,p_column_id=>wwv_flow_api.id(30390353114236832)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>60
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(30330404123676648)
,p_view_id=>wwv_flow_api.id(56481460615961563)
,p_display_seq=>3
,p_column_id=>wwv_flow_api.id(30175986567830561)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>125
,p_sort_order=>1
...
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(30300750576326397)
,p_view_id=>wwv_flow_api.id(56481460615961563)
,p_display_seq=>12
,p_column_id=>wwv_flow_api.id(30175597196830557)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(30274879096821375)
,p_view_id=>wwv_flow_api.id(56481460615961563)
,p_display_seq=>0
,p_column_id=>wwv_flow_api.id(30175183789830553)
,p_is_visible=>true
,p_is_frozen=>true
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(30182924817891864)
,p_view_id=>wwv_flow_api.id(56481460615961563)
,p_display_seq=>5
,p_column_id=>wwv_flow_api.id(30173162546830533)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>130
,p_sort_order=>2
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(30171950549830521)
...
,p_plug_source_type=>'NATIVE_IG'
,p_master_region_id=>wwv_flow_api.id(56482505258961575)
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(71114346945695632)
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(30172783240830529)
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(30172709180830528)
,p_name=>'IN_KEY'
,p_source_type=>'DB_COLUMN'
...
,p_is_required=>false
,p_lov_type=>'SHARED'
,p_lov_id=>wwv_flow_api.id(30296801724267755)
,p_lov_display_extra=>false
,p_lov_display_null=>false
,p_enable_filter=>true
,p_filter_operators=>'C:S:CASE_INSENSITIVE:REGEXP'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(30172602551830527)
,p_name=>'FORMAT_MASK'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(30172421789830526)
,p_name=>'DATA_TYPE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(30172336389830525)
,p_name=>'TABLE_COLUMN'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(30172228758830524)
,p_name=>'FILE_COLUMN'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(30172162216830523)
,p_name=>'VIEW_NAME'
,p_source_type=>'DB_COLUMN'
,p_source_expression=>'VIEW_NAME'
,p_data_type=>'VARCHAR2'
...
,p_enable_hide=>true
,p_is_primary_key=>true
,p_parent_column_id=>wwv_flow_api.id(56480212700961553)
,p_include_in_export=>false
);
wwv_flow_api.create_interactive_grid(
 p_id=>wwv_flow_api.id(30172082547830522)
...
wwv_flow_api.create_ig_report(
 p_id=>wwv_flow_api.id(30177573054852546)
,p_interactive_grid_id=>wwv_flow_api.id(30172082547830522)
,p_static_id=>'297034'
,p_type=>'PRIMARY'
,p_default_view=>'GRID'
,p_rows_per_page=>5
...
wwv_flow_api.create_ig_report_view(
 p_id=>wwv_flow_api.id(30177712828852547)
,p_report_id=>wwv_flow_api.id(30177573054852546)
,p_view_type=>'GRID'
,p_stretch_columns=>true
,p_srv_exclude_null_values=>false
,p_srv_only_display_columns=>true
...
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(70720004275709499)
,p_view_id=>wwv_flow_api.id(30177712828852547)
,p_display_seq=>7
,p_column_id=>wwv_flow_api.id(71114346945695632)
,p_is_visible=>false
,p_is_frozen=>false
,p_sort_order=>1
...
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(30181445102852572)
,p_view_id=>wwv_flow_api.id(30177712828852547)
,p_display_seq=>6
,p_column_id=>wwv_flow_api.id(30172783240830529)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>80
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(30180915476852570)
,p_view_id=>wwv_flow_api.id(30177712828852547)
,p_display_seq=>5
,p_column_id=>wwv_flow_api.id(30172709180830528)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>40
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(30180453738852568)
,p_view_id=>wwv_flow_api.id(30177712828852547)
,p_display_seq=>4
,p_column_id=>wwv_flow_api.id(30172602551830527)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>80
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(30180007485852567)
,p_view_id=>wwv_flow_api.id(30177712828852547)
,p_display_seq=>2
,p_column_id=>wwv_flow_api.id(30172421789830526)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>120
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(30179485939852565)
,p_view_id=>wwv_flow_api.id(30177712828852547)
,p_display_seq=>1
,p_column_id=>wwv_flow_api.id(30172336389830525)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>120
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(30178965086852563)
,p_view_id=>wwv_flow_api.id(30177712828852547)
,p_display_seq=>3
,p_column_id=>wwv_flow_api.id(30172228758830524)
,p_is_visible=>true
,p_is_frozen=>false
,p_width=>70
);
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(30178461345852558)
,p_view_id=>wwv_flow_api.id(30177712828852547)
,p_display_seq=>1
,p_column_id=>wwv_flow_api.id(30172162216830523)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(24404690177273016)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(24404572008273016)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(24404470683273016)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(6489864168588345)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(24174583797404465)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(24404572008273016)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(24407771080273018)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(24404690177273016)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(24509591879351517)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(24407986531273018)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(32133084212737640)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(6489864168588345)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(24410425757273020)
...
,p_branch_when_button_id=>wwv_flow_api.id(24509591879351517)
,p_branch_sequence=>20
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(24409780526273020)
...
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(24407986531273018)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(34363027931905454)
,p_name=>'P3_LOAD_FILE_INFO_HISTORY_COUNT'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(6489864168588345)
,p_item_default=>'0'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31064233334372636)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30529117918257448)
,p_name=>'P3_OWNER'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(24404572008273016)
,p_item_default=>'&APPLICATION_OWNER.'
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30389378361236822)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30228042504332430)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30227291393331060)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30226458733328251)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30176354977830565)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30174181414830543)
,p_name=>'P3_CSV_FILE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(24404572008273016)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30173751163830539)
,p_name=>'P3_VIEW_NAME'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(6489864168588345)
,p_prompt=>'View Name'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(24407475024273018)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(24407069833273018)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(24406643220273018)
,p_name=>'P3_FILE_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(24404572008273016)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(24406296543273018)
,p_name=>'P3_FILE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(24404572008273016)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(24172175842404441)
,p_name=>'P3_FILE_NAME'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(24404572008273016)
,p_prompt=>'File'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(30175661636830558)
,p_name=>'Enable Items'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(24509591879351517)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(30175754309830559)
,p_event_id=>wwv_flow_api.id(30175661636830558)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(24408182837273018)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(24407771080273018)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(24408961576273019)
,p_event_id=>wwv_flow_api.id(24408182837273018)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(34363560495905459)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(34363683448905460)
,p_event_id=>wwv_flow_api.id(34363560495905459)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(30173563123830537)
,p_name=>'Select Load Info History'
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(56482505258961575)
,p_bind_type=>'bind'
,p_bind_event_type=>'NATIVE_IG|REGION TYPE|interactivegridselectionchange'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(30173669363830538)
,p_event_id=>wwv_flow_api.id(30173563123830537)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(30390924311236838)
,p_name=>'DisableItems'
,p_event_sequence=>40
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(30391045845236839)
,p_event_id=>wwv_flow_api.id(30390924311236838)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(30392185870236850)
,p_name=>'Submit Page'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(24509591879351517)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(32127500137587955)
,p_event_id=>wwv_flow_api.id(30392185870236850)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(30392338928236852)
,p_event_id=>wwv_flow_api.id(30392185870236850)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(32133276088742038)
,p_name=>'Toggle All Sheets'
,p_event_sequence=>60
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(32133084212737640)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(32133681414742054)
,p_event_id=>wwv_flow_api.id(32133276088742038)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(32124845534587929)
,p_event_id=>wwv_flow_api.id(32133276088742038)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(30175338327830555)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_api.id(56482505258961575)
