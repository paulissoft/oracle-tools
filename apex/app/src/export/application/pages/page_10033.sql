...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(32170716720322649)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(32170610479322649)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(32170855007322649)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(32170610479322649)
,p_button_name=>'NEXT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(32171003317322649)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(32173599671322650)
,p_branch_name=>'Go To Next Step'
,p_branch_action=>'f?p=&APP_ID.:10034:&SESSION.::&DEBUG.:RP,10034::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(32170855007322649)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32174739676322651)
,p_name=>'P10033_USERNAME_FORMAT'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(32170716720322649)
,p_prompt=>'Username Format'
,p_display_as=>'NATIVE_CHECKBOX'
,p_named_lov=>'EMAIL_USERNAME_FORMAT'
,p_lov=>'.'||wwv_flow_api.id(32174842435322651)||'.'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32174390853322651)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32173977650322650)
,p_name=>'P10033_ROLE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(32170716720322649)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(32171079531322649)
,p_name=>'Cancel Modal'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(32171003317322649)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(32176011909322654)
,p_event_id=>wwv_flow_api.id(32171079531322649)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(32176581237322654)
...
,p_process_when_button_id=>wwv_flow_api.id(32170855007322649)
);
