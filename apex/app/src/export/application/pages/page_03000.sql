...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(107384715112091295)
...
,p_list_id=>wwv_flow_api.id(80161703882417986)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(82090685888338118)
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(80162277189417993)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(76443638027080643)
,p_plug_name=>'Components'
,p_icon_css_classes=>'fa-lg fa-shapes u-color-15'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(82146630262338152)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_attribute_01=>'N'
