...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(47660860086446267)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(393029003165022635)
,p_plug_name=>'Components'
,p_icon_css_classes=>'fa-lg fa-shapes u-color-15'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(49645213159366426)
,p_plug_display_sequence=>10
,p_plug_display_point=>'REGION_POSITION_01'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(678917025136914313)
...
,p_list_id=>wwv_flow_api.id(47660286779446260)
