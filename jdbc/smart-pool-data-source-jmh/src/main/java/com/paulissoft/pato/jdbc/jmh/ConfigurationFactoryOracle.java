...
public class ConfigurationFactoryOracle {
    ...
    // SmartPoolDataSourceOracle.class (2)
    @Bean(name = {"authDataSourceOracle2"})
    @ConfigurationProperties(prefix = "app.auth.datasource.oracleucp")
    public SmartPoolDataSourceOracle authDataSourceOracle2(@Qualifier("authDataSourceProperties") DataSourceProperties properties) {
    ...
    @ConfigurationProperties(prefix = "app.domain.datasource.oracleucp")
    public SmartPoolDataSourceOracle domainDataSourceOracle2(@Qualifier("domainDataSourceProperties") DataSourceProperties properties) {
    ...
    @ConfigurationProperties(prefix = "app.operator.datasource.oracleucp")
    public SmartPoolDataSourceOracle operatorDataSourceOracle2(@Qualifier("operatorDataSourceProperties") DataSourceProperties properties) {
