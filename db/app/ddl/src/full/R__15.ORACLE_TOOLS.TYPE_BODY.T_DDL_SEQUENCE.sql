...
overriding member procedure text_to_compare( self in oracle_tools.t_ddl_sequence, p_text_tab out nocopy t_text_tab )
is
...
begin
  ...
  p_text_tab := t_text_tab(regexp_replace(self.text(1), l_find_regexp, l_repl_regexp));
end text_to_compare;
