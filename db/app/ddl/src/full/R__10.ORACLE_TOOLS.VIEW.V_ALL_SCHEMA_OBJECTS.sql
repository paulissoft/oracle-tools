CREATE OR REPLACE FORCE VIEW "ORACLE_TOOLS"."V_ALL_SCHEMA_OBJECTS" ("SESSION_ID", "SEQ", "SCHEMA_OBJECT_FILTER_ID", "SCHEMA_OBJECT_ID", "CREATED", "OBJ", "LAST_DDL_TIME", "GENERATE_DDL", "DDL_GENERATED") BEQUEATH CURRENT_USER AS 
...
,       gdsso.created
,       so.obj
,       so.obj.last_ddl_time() as last_ddl_time
,       sofr.generate_ddl
