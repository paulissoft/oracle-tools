CREATE OR REPLACE VIEW "ORACLE_TOOLS"."V_ALL_SCHEMA_OBJECTS" ("SESSION_ID", "SEQ", "SCHEMA_OBJECT_FILTER_ID", "SCHEMA_OBJECT_ID", "CREATED", "OBJ", "GENERATE_DDL", "DDL_GENERATED") BEQUEATH CURRENT_USER AS 
