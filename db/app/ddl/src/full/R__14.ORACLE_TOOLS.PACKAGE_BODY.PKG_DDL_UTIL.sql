...
$end      
      ...
      then
        open l_cursor for
          ...
          ,       s.chunk
          from
                  oracle_tools.v_my_schema_ddls s
...
$end
      ...
      then
        ...
        loop
          if p_network_link is not null
          then
            l_my_schema_ddl_tmp_tab(i_idx).obj.network_link(p_network_link);
          end if;
          ...
          then
            ...
            , 'remap schema not implemented.'
            , l_my_schema_ddl_tmp_tab(i_idx).obj.id
            );
          end if;
