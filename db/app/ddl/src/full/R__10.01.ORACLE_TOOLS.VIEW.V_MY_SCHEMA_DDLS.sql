CREATE OR REPLACE VIEW "ORACLE_TOOLS"."V_MY_SCHEMA_DDLS" ("SESSION_ID", "SCHEMA_OBJECT_ID", "DDL#", "CHUNK#", "OBJ", "LAST_DDL_TIME", "VERB", "DDL_INFO", "CHUNK") BEQUEATH CURRENT_USER AS 
