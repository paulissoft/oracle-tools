CREATE OR REPLACE VIEW "ORACLE_TOOLS"."V_MY_SCHEMA_OBJECT_FILTER_RESULTS" ("SCHEMA_OBJECT_FILTER_ID", "SCHEMA_OBJECT_FILTER", "SCHEMA_OBJECT_ID", "SCHEMA_OBJECT", "GENERATE_DDL") BEQUEATH CURRENT_USER AS 
