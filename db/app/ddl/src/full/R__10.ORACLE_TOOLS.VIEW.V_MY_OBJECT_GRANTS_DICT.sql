CREATE OR REPLACE FORCE VIEW "ORACLE_TOOLS"."V_MY_OBJECT_GRANTS_DICT" ("BASE_OBJECT_SCHEMA", "BASE_OBJECT_NAME", "GRANTEE", "PRIVILEGE", "GRANTABLE") BEQUEATH CURRENT_USER AS 
