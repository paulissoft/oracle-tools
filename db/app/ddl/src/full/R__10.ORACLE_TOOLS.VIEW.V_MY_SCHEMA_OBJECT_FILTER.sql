...
,       sof.obj_json
--,       treat(oracle_tools.t_object_json.deserialize('ORACLE_TOOLS.T_SCHEMA_OBJECT_FILTER', sof.obj) as oracle_tools.t_schema_object_filter) as obj
,       sof.obj_json.schema$ as schema
,       sof.obj_json.grantor_is_schema$ as grantor_is_schema
