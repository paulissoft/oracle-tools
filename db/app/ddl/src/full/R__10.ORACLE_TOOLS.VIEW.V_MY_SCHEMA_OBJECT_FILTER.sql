CREATE OR REPLACE FORCE VIEW "ORACLE_TOOLS"."V_MY_SCHEMA_OBJECT_FILTER" ("SESSION_ID", "SCHEMA_OBJECT_FILTER_ID", "OBJ", "SCHEMA", "GRANTOR_IS_SCHEMA")  BEQUEATH CURRENT_USER AS 
