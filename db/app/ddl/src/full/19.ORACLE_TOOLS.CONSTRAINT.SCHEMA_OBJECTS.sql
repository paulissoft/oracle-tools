...
ALTER TABLE "ORACLE_TOOLS"."SCHEMA_OBJECTS" ADD CONSTRAINT "SCHEMA_OBJECTS$CK$OBJ$LAST_DDL_TIME$" CHECK (obj.last_ddl_time$ is not null) DEFERRABLE INITIALLY DEFERRED ENABLE;
