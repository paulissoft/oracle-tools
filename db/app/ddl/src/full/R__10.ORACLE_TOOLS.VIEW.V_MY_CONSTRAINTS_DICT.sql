CREATE OR REPLACE FORCE VIEW "ORACLE_TOOLS"."V_MY_CONSTRAINTS_DICT" ("OBJECT_SCHEMA", "OBJECT_TYPE", "OBJECT_NAME", "BASE_OBJECT_SCHEMA", "BASE_OBJECT_NAME", "CONSTRAINT_TYPE", "SEARCH_CONDITION") BEQUEATH CURRENT_USER AS 
