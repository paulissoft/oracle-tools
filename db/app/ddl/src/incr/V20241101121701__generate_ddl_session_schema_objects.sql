...
, ddl oracle_tools.t_schema_ddl constraint all_schema_ddls$ck$ddl check (ddl is null or ddl.obj is null or ddl.obj.id = schema_object_id) -- only ddl for this schema object
