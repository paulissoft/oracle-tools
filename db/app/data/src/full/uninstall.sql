...
-- object names        : DATA_SESSION_USERNAME,DATA_TIMESTAMP,DATA_API_PKG,DATA_BR_PKG,DATA_PARTITIONING_PKG,DATA_TABLE_MGMT_PKG,DATA_ROW_T,DATA_ROW_ID_T,DATA_DML_EVENT_MGR_PKG
-- skip repeatables    : 0
