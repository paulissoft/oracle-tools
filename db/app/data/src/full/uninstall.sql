...
/* SQL statement 1 (REVOKE;;OBJECT_GRANT;;ORACLE_TOOLS;FUNCTION;DATA_SESSION_USERNAME;;PUBLIC;EXECUTE;NO;2) */
call dbms_application_info.set_action('SQL statement 1');
REVOKE EXECUTE ON "ORACLE_TOOLS"."DATA_SESSION_USERNAME" FROM "PUBLIC";

/* SQL statement 2 (DROP;ORACLE_TOOLS;FUNCTION;DATA_SESSION_USERNAME;;;;;;;;2) */
call dbms_application_info.set_action('SQL statement 2');
DROP FUNCTION ORACLE_TOOLS.DATA_SESSION_USERNAME;

/* SQL statement 3 (REVOKE;;OBJECT_GRANT;;ORACLE_TOOLS;FUNCTION;DATA_TIMESTAMP;;PUBLIC;EXECUTE;NO;2) */
call dbms_application_info.set_action('SQL statement 3');
REVOKE EXECUTE ON "ORACLE_TOOLS"."DATA_TIMESTAMP" FROM "PUBLIC";

/* SQL statement 4 (DROP;ORACLE_TOOLS;FUNCTION;DATA_TIMESTAMP;;;;;;;;2) */
call dbms_application_info.set_action('SQL statement 4');
DROP FUNCTION ORACLE_TOOLS.DATA_TIMESTAMP;

/* SQL statement 5 (REVOKE;;OBJECT_GRANT;;ORACLE_TOOLS;PACKAGE_SPEC;DATA_API_PKG;;PUBLIC;EXECUTE;NO;2) */
