...
/* SQL statement 5 (REVOKE;;OBJECT_GRANT;;ORACLE_TOOLS;PACKAGE_SPEC;DATA_SQL_PKG;;PUBLIC;EXECUTE;NO;2) */
call dbms_application_info.set_action('SQL statement 5');
REVOKE EXECUTE ON "DATA_SQL_PKG" FROM "PUBLIC";

/* SQL statement 6 (REVOKE;;OBJECT_GRANT;;ORACLE_TOOLS;PACKAGE_SPEC;DATA_TABLE_MGMT_PKG;;PUBLIC;EXECUTE;NO;2) */
call dbms_application_info.set_action('SQL statement 6');
REVOKE EXECUTE ON "DATA_TABLE_MGMT_PKG" FROM "PUBLIC";

/* SQL statement 7 (REVOKE;;OBJECT_GRANT;;ORACLE_TOOLS;FUNCTION;DATA_TIMESTAMP;;PUBLIC;EXECUTE;NO;2) */
call dbms_application_info.set_action('SQL statement 7');
REVOKE EXECUTE ON "DATA_TIMESTAMP" FROM "PUBLIC";

/* SQL statement 8 (DROP;ORACLE_TOOLS;FUNCTION;DATA_SESSION_ID;;;;;;;;2) */
