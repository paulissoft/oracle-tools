...
prompt @@R__08.FUNCTION.DATA_CALL_INFO.sql
@@R__08.FUNCTION.DATA_CALL_INFO.sql
show errors FUNCTION "DATA_CALL_INFO"
...
prompt @@R__08.FUNCTION.DATA_SHOW_WITHOUT_AUDITING_COLUMNS.sql
@@R__08.FUNCTION.DATA_SHOW_WITHOUT_AUDITING_COLUMNS.sql
show errors FUNCTION "DATA_SHOW_WITHOUT_AUDITING_COLUMNS"
...
prompt @@R__09.PACKAGE_SPEC.DATA_AUDITING_PKG.sql
@@R__09.PACKAGE_SPEC.DATA_AUDITING_PKG.sql
show errors PACKAGE "DATA_AUDITING_PKG"
...
prompt @@R__14.PACKAGE_BODY.DATA_AUDITING_PKG.sql
@@R__14.PACKAGE_BODY.DATA_AUDITING_PKG.sql
show errors PACKAGE BODY "DATA_AUDITING_PKG"
...
prompt @@R__18.OBJECT_GRANT.DATA_AUDITING_PKG.sql
@@R__18.OBJECT_GRANT.DATA_AUDITING_PKG.sql
prompt @@R__18.OBJECT_GRANT.DATA_BR_PKG.sql
@@R__18.OBJECT_GRANT.DATA_BR_PKG.sql
prompt @@R__18.OBJECT_GRANT.DATA_CALL_INFO.sql
@@R__18.OBJECT_GRANT.DATA_CALL_INFO.sql
...
prompt @@R__18.OBJECT_GRANT.DATA_SHOW_WITHOUT_AUDITING_COLUMNS.sql
@@R__18.OBJECT_GRANT.DATA_SHOW_WITHOUT_AUDITING_COLUMNS.sql
