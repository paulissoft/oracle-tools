...
prompt @@02.TYPE_SPEC.DATA_ROW_ID_T.sql
@@02.TYPE_SPEC.DATA_ROW_ID_T.sql
show errors TYPE "DATA_ROW_ID_T"
...
prompt @@R__09.PACKAGE_SPEC.DATA_DML_EVENT_MGR_PKG.sql
@@R__09.PACKAGE_SPEC.DATA_DML_EVENT_MGR_PKG.sql
show errors PACKAGE "DATA_DML_EVENT_MGR_PKG"
...
prompt @@R__11.PROCEDURE.DATA_ROW_NOTIFICATION_PRC.sql
@@R__11.PROCEDURE.DATA_ROW_NOTIFICATION_PRC.sql
show errors PROCEDURE "DATA_ROW_NOTIFICATION_PRC"
...
prompt @@R__14.PACKAGE_BODY.DATA_DML_EVENT_MGR_PKG.sql
@@R__14.PACKAGE_BODY.DATA_DML_EVENT_MGR_PKG.sql
show errors PACKAGE BODY "DATA_DML_EVENT_MGR_PKG"
...
prompt @@R__15.TYPE_BODY.DATA_ROW_ID_T.sql
@@R__15.TYPE_BODY.DATA_ROW_ID_T.sql
show errors TYPE BODY "DATA_ROW_ID_T"
...
prompt @@R__18.OBJECT_GRANT.DATA_DML_EVENT_MGR_PKG.sql
@@R__18.OBJECT_GRANT.DATA_DML_EVENT_MGR_PKG.sql
...
prompt @@R__18.OBJECT_GRANT.DATA_ROW_NOTIFICATION_PRC.sql
@@R__18.OBJECT_GRANT.DATA_ROW_NOTIFICATION_PRC.sql
prompt @@R__18.OBJECT_GRANT.DATA_ROW_ID_T.sql
@@R__18.OBJECT_GRANT.DATA_ROW_ID_T.sql
