...
/* SQL statement 1 (REVOKE;;OBJECT_GRANT;;ORACLE_TOOLS;PACKAGE_SPEC;API_CALL_STACK_PKG;;PUBLIC;EXECUTE;NO;2) */
call dbms_application_info.set_action('SQL statement 1');
REVOKE EXECUTE ON "API_CALL_STACK_PKG" FROM "PUBLIC";

/* SQL statement 2 (REVOKE;;OBJECT_GRANT;;ORACLE_TOOLS;PACKAGE_SPEC;API_HEARTBEAT_PKG;;PUBLIC;EXECUTE;NO;2) */
...
/* SQL statement 4 (REVOKE;;OBJECT_GRANT;;ORACLE_TOOLS;PACKAGE_SPEC;API_PKG;;PUBLIC;EXECUTE;NO;2) */
call dbms_application_info.set_action('SQL statement 4');
REVOKE EXECUTE ON "API_PKG" FROM "PUBLIC";

/* SQL statement 5 (REVOKE;;OBJECT_GRANT;;ORACLE_TOOLS;PACKAGE_SPEC;API_TIME_PKG;;PUBLIC;EXECUTE;NO;2) */
call dbms_application_info.set_action('SQL statement 5');
REVOKE EXECUTE ON "API_TIME_PKG" FROM "PUBLIC";

/* SQL statement 6 (DROP;ORACLE_TOOLS;PACKAGE_BODY;API_CALL_STACK_PKG;;;;;;;;2) */
call dbms_application_info.set_action('SQL statement 6');
DROP PACKAGE BODY API_CALL_STACK_PKG;

/* SQL statement 7 (DROP;ORACLE_TOOLS;PACKAGE_BODY;API_HEARTBEAT_PKG;;;;;;;;2) */
